...
def placeholder_inputs(batch_size):
    ...
    return images_placeholder, labels_placeholder, mode


# In[5]:

def fill_feed_dict(data_set, images_pl, labels_pl, mode, val):
...
def run_training():
    ...
    # Generate placeholders for the images and labels.
        images_placeholder, labels_placeholder, mode = placeholder_inputs(FLAGS.batch_size)
    ...
    #             summary_writer.flush()
            ...
            if (step + 1) % 1000 == 0 or (step + 1) == FLAGS.max_steps:
                saver.save(sess, '.models/model-spatial-CNN-'+str(IMAGE_SIZE)+'X'+str(IMAGE_SIZE)+'.ckpt', global_step=step)
